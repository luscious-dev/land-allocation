...
exports.updateProfile = exports.updatePassword = exports.signUp = exports.logout = exports.login = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch("/api/v1/user/updateMe", data);
        case 3:
          res = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.patch("/api/v1/user/updatePassword", data);
        case 3:
          res = _context2.sent;
        ...
        case 8:
          ...
          (0, _alerts.showAlert)("failure", _context2.t0.response.data.message);
        case 11:
        case "end":
...
var buyLand = exports.buyLand = /*#__PURE__*/function () {
...
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addLand = exports.addLand = function addLand(data) {
...
var updateLand = exports.updateLand = function updateLand(id, data) {
...
var deleteLand = exports.deleteLand = function deleteLand(id, domItem) {
...
var applyForCofo = exports.applyForCofo = function applyForCofo(data) {
...
var printCofo = exports.printCofo = function printCofo(id) {
...
var approveCofo = exports.approveCofo = function approveCofo(id, lastChanged, articleCard) {
...
var rejectCofo = exports.rejectCofo = function rejectCofo(id, lastChanged, articleCard) {
  _axios.default.patch("/api/v1/certificate-of-ownership/".concat(id), {
    DelFlag: 1,
    LastChanged: lastChanged
  }).then(function (res) {
...
exports.default = void 0;
var objectExtend = exports.default = extend;
...
var printCofoBtns = document.querySelectorAll(".print-cofo");
if (printCofoBtns.length > 0) {
  printCofoBtns.forEach(function (printCofoBtn) {
...
var updateProfileBtn = document.querySelector("#update-profile");
var updatePasswordBtn = document.querySelector("#update-password");
if (updateProfileBtn) {
  updateProfileBtn.addEventListener("click", function (e) {
    e.preventDefault();
    var data = {
      LastChanged: JSON.parse(document.querySelector("#LastChanged").value),
      FirstName: document.querySelector("#firstName").value == "" ? undefined : document.querySelector("#firstName").value,
      LastName: document.querySelector("#lastName").value == "" ? undefined : document.querySelector("#lastName").value,
      MiddleName: document.querySelector("#middleName").value == "" ? undefined : document.querySelector("#middleName").value,
      Phone: document.querySelector("#phone").value == "" ? undefined : document.querySelector("#phone").value
    };
    (0, _login.updateProfile)(data).then(function (res) {
      document.querySelector("#LastChanged").value = JSON.stringify(res.data.user.LastChanged);
      console.log(res);
    });
  });
}
if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener("click", function (e) {
    ...
    (0, _login.updatePassword)(data).then(function (res) {
      document.querySelector("#LastChanged").value = JSON.stringify(res.data.user.LastChanged);
      console.log(res);
    });
  });
